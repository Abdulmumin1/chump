...
Chump runs one authenticated local service for the CLI and web app. Projects
are registered with that service, and switching projects changes workspace and
session context without starting another process.
...
```powershell
irm https://chmp.dev/install.ps1 | iex
```
...
chump app                     # Start the local service and open https://chmp.dev/c
...
chump stop                     # Stop the local service
